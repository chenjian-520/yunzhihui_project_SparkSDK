...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public Map<String, Object> info(int id) {
        XxlJobInfo info = xxlJobInfoDao.info(id);
        XxlJobDynamicScheduler.fillJobInfo(info);
    ...
    public ReturnT<String> update(XxlJobInfo jobInfo) {
        ...
        exists_jobInfo.setTaskModel(jobInfo.getTaskModel());
        exists_jobInfo.setTaskModelText(jobInfo.getTaskModelText());
        exists_jobInfo.setTaskType(jobInfo.getTaskType());
        exists_jobInfo.setTaskTypeText(jobInfo.getTaskTypeText());
        exists_jobInfo.setTaskId(jobInfo.getTaskId());
