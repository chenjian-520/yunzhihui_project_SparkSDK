	...
	private void failAlarm(XxlJobInfo info, XxlJobLog jobLog){
		...
		if (info!=null && info.getAlarmEmail()!=null && info.getAlarmEmail().trim().length()>0) {
			...
			for (String email: emailSet) {
				...
				sb.append("\r\n");
				sb.append("任务描述: ");
				sb.append(info.getJobDesc());
				sb.append("\r\n");
				sb.append("告警类型: ");
				sb.append(I18nUtil.getString("jobconf_monitor_alarm_type"));
				sb.append("\r\n");
				sb.append("告警内容: ");
				sb.append(alarmContent);
				// TODO songchao 2019-10-29 发送邮件方式修改
				// MailUtil.sendMail(email, title, content);
				MailUtil.sendMailByHttpRestful(email, title, sb.toString());
			}
		}
